<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="users_login.aspx.cs" Inherits="TaskManager.user.users_login" %>
            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form id="f1" runat="server">
                        ...
                        <p>Don't Have an account? <a href="users_registration.aspx" style="color:black">Register Now</a></p>
                        <p>You are an admin? <a href="../admin/login.aspx" style="color:black">Admin Login</a></p>
                        ...
                        <div class="alert alert-danger" id="error" runat="server" style="margin-top:10px; display:none">
                            <strong>Invalid login credentials!s</strong>
                        </div>
                    </form>
                </div>
            </div>
